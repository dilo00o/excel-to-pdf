...
public class ExcelToHtmlConverter {
	 ...
	 * @return An object for converting the workbook to HTML.
	 */
//	public static ExcelToHtmlConverter create(File path, Appendable output) throws IOException {
//		return create(path, output);
//	}
	 ...
	 * @return An object for converting the workbook to HTML.
	 */
	public static ExcelToHtmlConverter create(File in, Appendable output) throws IOException {
		try {
...
//	}
	...
	public void generateHtml() throws IOException {
		System.out.println("bazgina mofo");
		try {
			ensureOut();
			if (completeHTML) {
	...
	public void printStyles() {
		...
		try {
			URL resource = getClass().getClassLoader().getResource("excelStyle.css");
			in = new BufferedReader(new InputStreamReader(new FileInputStream(new File(resource.getFile()))));
			String line;
